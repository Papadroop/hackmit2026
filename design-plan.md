...
- **One orchestrated moment, spread across the scroll.** The first viewport opens with the word "rinse" in ink on clean paper and three quarters of the card still under green pigment, moving as if under running water. Scrolling takes the rest of the pigment down behind a waterline that runs in waves and cuts channels through it; the tagline under the line comes up in ink as the water passes it. Below the card, ink trees draw themselves in growth order and leaf last. Nothing below the card fades or slides in — the forest is the motion there.
