...
| Wayback, shell.com/sustainability/our-climate-target.html and `.model.json` (re-checked 2026-09-20) | 50 distinct HTML captures 2024-03-01 → 2025-03-23; **2** captures of the content model, 2024-03-14 and 2024-11-05 | The HTML captures are JavaScript shells, so only the two content-model captures hold the text. The 2024-03-14 07:11:28 UTC one is the page as it stood before that day's strategy update (20% NCI by 2030, 45% by 2035); it is `demo-documents/shell-our-climate-target-2024-03-14.md`. The live URL now 301-redirects to /sustainability/climate.html. The CDX index answers 429/503 freely; retry rather than hammer. |
...
- `demo-documents/shell-our-climate-target-2024-03-14.md` — Shell's **predecessor** climate page, the second document for the company view (roadmap step 18b). Same format; read from the Wayback Machine's capture of that page's AEM content model at 2024-03-14 07:11:28 UTC, fetched 2026-09-20. 1,977 words; the transcript of the embedded “Shell’s journey to net zero” video (6,369 words, a separate work with its own cautionary note) was removed by hand, which the file's `method` records. It still states the pre-update targets — 20% net carbon intensity by 2030 and 45% by 2035 — that the successor page replaced with 15-20% by 2030 and dropped. Live run: `backend/data/runs/20260920T145459Z-7a7050cafa.jsonl`.
